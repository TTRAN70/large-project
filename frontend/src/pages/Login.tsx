    ...
    <div className="flex min-h-[calc(100vh-3.5rem)] flex-col items-center justify-center px-4">
      ...
      >
        ...
        <p className="pt-1 text-sm text-gray-300">
          ...
          <Link to="/signup" className="text-[#1ec3ff] hover:underline">
            Sign up
          </Link>
        </p>
      </form>
      <p className="justify-bottom mt-10 flex content-end text-sm text-gray-300">
        <Link to="/reset" className="text-[#1ec3ff] hover:underline">
          Forgot password?
        </Link>
      </p>
    </div>
