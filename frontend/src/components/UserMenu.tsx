...
export default function UserMenu({ user }: { user: string }) {
  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      <button
        onClick={() => setOpen((o) => !o)}
        className="inline-flex items-center gap-2 rounded-full bg-[#1ec3ff]/15 px-3 py-1.5 text-sm text-[#a7e9ff] hover:bg-[#1ec3ff]/25 focus:ring-2 focus:ring-[#1ec3ff]/50 focus:outline-none"
        aria-haspopup="menu"
        aria-expanded={open}
